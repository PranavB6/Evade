...
/* You Can Edit any of these #defines */

#define DODGER_SPEED 100 // Lower = Higher speed
#define DODGER_SIZE 5 // Width and height of the dodger

#define BULLET_SIZE 3 // width and height of the bullets
#define BULLET_SPEED 3
#define TOTAL_BULLETS 20 // Maximum amount of bullets allowed to be in the game
...
#define DEBOUNCE_DELAY 400 // Minimum amount of time between each shot. Lower = faster shooting
...
void EndGame(int currentscore, Bullet bullets[]){
